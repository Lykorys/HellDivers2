...
{
    public class SmallHEBarragePlaceable : StratagemPlaceable
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
            sequence = new List<Arrows> { Arrows.RIGHT, Arrows.RIGHT, Arrows.DOWN, Arrows.LEFT, Arrows.RIGHT,Arrows.DOWN };
            givenStrat = ModContent.GetInstance<SmallHEBarrageStratagem>();
            cooldown = 180;
            OriginalCD=180;
            resetSequence();
        }
    }
    public class SmallHEBarrageStratagem : StratagemItem
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
            ...
            Item.shoot = ModContent.ProjectileType<SmallHEBarrageStratagemEntity>();
        }
    }
    public class SmallHEBarrageStratagemEntity : StratagemEntity
    {

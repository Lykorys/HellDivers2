...
public class KGBombStratagem : StratagemItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.shootSpeed = 8f;
        timeToDetonate=120;
        color=HellDivers2.Content.System.Colors.red;
...
public class KGBombStratagemEntity : StratagemEntity
{
    ...
    public override void onDetonate()
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.position,Projectile.velocity,ModContent.ProjectileType<KGBombProjectile>(),120,Projectile.owner);
        Projectile.Kill();
    }
}
